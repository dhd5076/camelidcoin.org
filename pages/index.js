      ...
      <div className="h-screen">
        <div className="justify-center items-center bg-gradient-to-b from-black/50" id="background">
          <div className="max-w-7xl mx-auto p-4 text-center text-white h-screen">
            ...
            <iframe className="mx-auto sm:w-1/2 sm:h-1/3" src="https://www.youtube.com/embed/bOj4yIexnHQ?si=r4j_wyZlOirKxM0c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </div>
      </div>
      <div className="container mx-auto p-6 relative z-10" id="features">
        ...
        <div className="mt-10 rounded-lg text-gray-100" id="faq">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white p-4 rounded-lg " id="contact">
